...
export const mockEmailTemplates: EmailTemplate[] = [
  ...
  },
  {
    ...
    subject: "Verify your Amanah email address",
    body: "Assalamu Alaikum {{name}},\n\nPlease verify your email address to complete your Amanah account setup.\n\nVerify Email: {{verificationLink}}\n\nThis link will expire in 24 hours.\n\nWassalam,\nAmanah Team",
  ...
  {
    id: "template-4",
    name: "Listing Now Live",
    subject: "Your {{subscriptionType}} is now live on Amanah!",
    body: "Assalamu Alaikum {{name}},\n\nGreat news! Your {{subscriptionType}} listing for {{subscriptionName}} has been verified and is now live on Amanah.\n\nCommunity members can now discover and engage with your listing.\n\nView your listing: {{viewLink}}\n\nJazakAllah Khair for being part of our community!\nAmanah Team",
    variables: ["name", "subscriptionType", "subscriptionName", "viewLink"],
    lastModified: "2024-12-18",
    active: true,
  },
  {
    id: "template-5",
    name: "Listing Update Pending",
    subject: "Your {{subscriptionType}} update is pending review",
    body: "Assalamu Alaikum {{name}},\n\nWe received your recent updates to {{subscriptionName}}.\n\nThese changes are currently pending staff review and will be live within 1-2 business days.\n\nThank you for keeping your listing up-to-date!\n\nWassalam,\nAmanah Team",
    variables: ["name", "subscriptionType", "subscriptionName"],
    lastModified: "2024-12-18",
    active: true,
  },
  {
  ...
  {
    id: "template-11",
    name: "Admin Alert - Listing Update Pending",
    subject: "{{subscriptionType}} update pending review: {{subscriptionName}}",
    body: "A member has submitted updates to their {{subscriptionType}} listing that require verification.\n\nDetails:\n- Name: {{subscriptionName}}\n- Member: {{memberName}}\n- Email: {{memberEmail}}\n- Updated fields: {{updatedFields}}\n\nPlease review and approve/reject in the admin portal.\n\nAmanah Admin",
    variables: ["subscriptionType", "subscriptionName", "memberName", "memberEmail", "updatedFields"],
    lastModified: "2024-12-18",
    active: true,
  },
  {
    id: "template-12",
    name: "Admin Alert - Push Notification Request",
    subject: "Push notification request from {{mosqueName}}",
    body: "A mosque has requested a push notification to be scheduled.\n\nDetails:\n- Mosque: {{mosqueName}}\n- Mosque Code: {{mosqueCode}}\n- Message: {{notificationMessage}}\n- Scheduled Date: {{scheduledDate}}\n- Scheduled Time: {{scheduledTime}}\n- Timezone: {{timezone}}\n\nPlease review and approve/reject in the admin portal.\n\nAmanah Admin",
    variables: ["mosqueName", "mosqueCode", "notificationMessage", "scheduledDate", "scheduledTime", "timezone"],
    lastModified: "2024-12-18",
    active: true,
  },
  {
    id: "template-13",
    name: "Push Notification Approved",
    subject: "Your push notification request has been approved",
    body: "Assalamu Alaikum {{mosqueName}},\n\nGreat news! Your push notification request has been approved and will be sent to our community.\n\nScheduled to send: {{scheduledDate}} at {{scheduledTime}} ({{timezone}})\n\nMessage:\n{{notificationMessage}}\n\nThank you for keeping the community engaged!\n\nJazakAllah Khair,\nAmanah Team",
    variables: ["mosqueName", "scheduledDate", "scheduledTime", "timezone", "notificationMessage"],
    lastModified: "2024-12-18",
    active: true,
  },
  {
    ...
    subject: "Your push notification request was not approved",
    body: "Assalamu Alaikum {{mosqueName}},\n\nWe received your push notification request, but it was not approved at this time.\n\nReason: {{rejectionReason}}\n\nYou can submit another request in {{daysUntilNextRequest}} days.\n\nFor questions, please contact our support team.\n\nWassalam,\nAmanah Team",
    variables: ["mosqueName", "rejectionReason", "daysUntilNextRequest"],
    lastModified: "2024-12-18",
    active: true,
  },
  {
    ...
    subject: "Your Amanah affiliate earnings for {{month}}",
    body: "Assalamu Alaikum {{mosqueName}},\n\nHere's your affiliate earnings report for {{month}}:\n\nTotal Kickbacks (10%): ${{totalKickbacks}}\nNumber of Businesses/Coupons: {{affiliateCount}}\nPayout Status: {{payoutStatus}}\n\nView detailed report: {{reportLink}}\n\nThank you for being part of our community growth!\n\nJazakAllah Khair,\nAmanah Team",
    variables: ["mosqueName", "month", "totalKickbacks", "affiliateCount", "payoutStatus", "reportLink"],
    lastModified: "2024-12-18",
    active: true,
  },
]
...
export const mockAdminSettings: AdminSettings = {
  ...
  enablePushNotificationRequests: true,
}
...
export const mockPushNotificationRequests: PushNotificationRequest[] = [
  {
    id: "push-1",
    mosqueId: "sub-1",
    mosqueName: "Easton Phillipsburg Muslim Association",
    mosqueCode: 1,
    title: "Ramadan Schedule 2025",
    message: "Join us for Taraweeh prayers starting March 1st at 8:30 PM. Special programs for youth and families.",
    scheduledDate: "2024-12-29",
    scheduledTime: "09:00",
    timezone: "America/New_York",
    requestedAt: "2024-12-15T10:00:00Z",
    requestedBy: "mosque@epma.org",
    status: "pending",
    lastRequestDate: "2024-12-15",
  },
  {
    id: "push-2",
    mosqueId: "sub-7",
    mosqueName: "Islamic Society of Basking Ridge",
    mosqueCode: 2,
    title: "Eid Al-Fitr Celebration",
    message: "Celebrate Eid with us! Prayer at 9 AM followed by community breakfast. All are welcome.",
    scheduledDate: "2024-11-24",
    scheduledTime: "08:00",
    timezone: "America/Chicago",
    requestedAt: "2024-11-20T14:00:00Z",
    requestedBy: "admin@isbr.org",
    status: "sent",
    sentAt: "2024-11-20T15:00:00Z",
    sentBy: "admin@amanah.com",
    lastRequestDate: "2024-11-20",
  },
]
